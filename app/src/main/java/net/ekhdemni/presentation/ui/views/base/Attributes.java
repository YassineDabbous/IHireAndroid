package net.ekhdemni.presentation.ui.views.base;
...
public class Attributes {
    ...
    public static int DEFAULT_THEME = R.array.orange;
    ...
    public static final String DEFAULT_FONT_FAMILY = "Monadi";
    ...
    public void setThemeSilent(int theme, Resources resources) {
        try {
            ...
            colors = new int[]{Color.parseColor("#732219"), Color.parseColor("#a63124"),
                    Color.parseColor("#d94130"), Color.parseColor("#808080")}; //#f2b6ae
        }
    }
